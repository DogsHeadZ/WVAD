...
class Hard_score_sample_generator(nn.Module):
    ...
    def forward(self, feat, scores_rgb, scores_flow):
        F_len = feat.shape[-1]
        hard_topK = 5  # 挑选出abnormal video中的x个困难样本，即异常分数值接近于0.5
        ...
        conf_abn_topK = 5  # 挑选出abnormal video中置信度高的x个clip作为abnormal
